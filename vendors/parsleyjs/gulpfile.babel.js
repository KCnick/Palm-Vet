...
function buildDoc(done) {
  ...
  docco.document({
    ...
    args: sources
      ...
      .pipe($.replace('<div id="jump_page">', '<div id="jump_page"><a class="source" href="../admin.html"><<< back to documentation</a>'))
...
function writeVersion() {
  return gulp.src(['admin.html', 'doc/download.html', 'README.md'], { base: "./" })
